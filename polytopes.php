...
<div class="content">
  ...
  <div class="func">
      ...
      <div class="content_block to_justify">
        ...
        <h2>Polywhat?</h2>
        A polytope is a mathematical object, with several different definitions. Then, let's redefine it! (yay!)<br>
		...
		Under this definition, a n-regular polytope will contain 2<SUP>n</SUP> vertices, and can be seen as the concatenation of 2 (n-1)-regular polytopes.<br>
    They were introduced in Corentin Guichaoua's PhD thesis [4]. It is planned in near future to present a document (in english) explaining these polytopes.<br>
    <br>
        ...
        <br>
        Many costs can be implemented, for instance reducing each chord on each vertex to its closest triad, and then consider the difference between two chords as a rotation in the circle of thirds (presented below), closely related to the circle of fifths.
        <img class="content-img rel-small" src="imgs/circle_thirds.png"/>
        <strong>And what about audio signals?</strong><br> Well, <s>that's actually my contribution!</s> I was planning on extending this work to audio signals, but I wasn't able to to do so. If you're interested for this task, you can contact me at axel.marmoret.at.irisa.fr or contact Frédéric Bimbot at bimbot.at.irisa.fr.
        <br><br>
        ...
        <br>
        <h2>Code</h2>
        Python code for this work, mixing both models, is available at <a class="inner-link" href="https://gitlab.inria.fr/amarmore/musiconpolytopes" target="_blank">this link</a> (for symbolic music only).<br>
        It's still under development, and lacks of (a lot) of explanations, but it's a first step! You can start by looking at the <a class="inner-link" href="https://gitlab.inria.fr/amarmore/musiconpolytopes/-/blob/master/Notebooks/Tutorial%20-%20Handling%20polytopes.ipynb" target="_blank">Tutorial Notebook</a>.<br>
        Don't hesitate to warn me if you encounter a bug or any problem!
      </div>
      <div class="content_block to_justify">
        ...
        <a class="inner-link" href="https://hal.inria.fr/hal-01188244" target="_blank">Link.</a>
        <br>
        [2] Louboutin, C., & Bimbot, F. (2017, June). Polytopic Graph of Latent Relations: A Multiscale Structure Model for Music Segments.
        <a class="inner-link" href="https://hal.archives-ouvertes.fr/hal-01653445/" target="_blank">Link.</a>
        <br>
        ...
        <a class="inner-link" href="https://www.theses.fr/2019REN1S012" target="_blank">Link.</a>
        <br>
        ...
        <a class="inner-link" href="https://tel.archives-ouvertes.fr/tel-01687054/" target="_blank">Link.</a>
      </div>
      <div></div>
    <footer>
      <div class="copyright">
